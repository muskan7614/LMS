       ...
       gap-10 md:gap-32 py-10 border-b border-white/30'>
        <div className='flex flex-col md:items-start items-center w-full'>
          ...
          <p className='mt-6 text-center md:text-left text-sm text-white/80'>Lorem, ipsum dolor sit amet consectetur adipisicing elit.
             Voluptatum fugit quis corrupti eum natus quibusdam ab facilis placeat, 
             consectetur beatae nisi itaque minima in quaerat expedita asperiores nihil laborum. Beatae?</p>
        </div>
        <div className='flex flex-col md:items-start items-center w-full'>
